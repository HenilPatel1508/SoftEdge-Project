  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-indigo-100">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="grid text-center text-2xl">Create your account</CardTitle>
        ...
        <CardFooter className="flex-col gap-3 ">
          <Button onClick={submitHandler} type="submit" className="w-full cursor-pointer p-5 bg-indigo-500 hover:bg-indigo-800">
            {loading?<><Loader2 className="h-4 w-4 animate-spin mr-2"/>Please Wait</>:'Signup'}
          </Button>
          <p>Already have an Account ? <Link to={'/login'} className="hover:underline cursor-pointer text-cyan-700">Login</Link></p>
        </CardFooter>
      </Card>
    </div>
  );
